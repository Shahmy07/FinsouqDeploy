...
export default function FormPropertySearchHome() {
    ...
    return (
        <div>
       <div className=''> 
                <Button variant="text" className='seeMoreCards mt-5 p-0' onClick={handleOpen}>View All <ChevronRightOutlinedIcon/></Button>
            </div>
