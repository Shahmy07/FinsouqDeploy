...
export default function ManageVendorOverlay() {
            ...
            >
                <Box sx={style} className='GenForms'>
                    ...
                    <div className='p-4'>
                        ...
                        <Button style={{ fontWeight: '500', color: '#D72752', fontSize: '16px', textTransform: 'none', padding: '0', textDecoration: 'underline' }}><span><i>i</i></span> Manage</Button>
                        </div>
                    </div>
                </Box>
            </Modal>
